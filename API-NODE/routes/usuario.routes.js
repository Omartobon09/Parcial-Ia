...
router.post('/', async (req, res) => {
    try {
        ...
        const nuevoUsuario = await Usuario.create({ nombre, apellido, usuario, contrasena: hashedPassword, rol_id });
...
router.put('/:id', async (req, res) => {
    try {
        ...
        await usuarioExistente.update({ nombre, apellido, usuario, contrasena: hashedPassword, rol_id });
